/*
 ...
 Source Schema         : mybookshop

 Target Server Type    : MySQL
 Target Server Version : 80031
 File Encoding         : 65001

 Date: 13/12/2025 18:45:11
*/
DROP DATABASE IF EXISTS mybookshop ;
CREATE DATABASE mybookshop CHARACTER SET utf8;
use mybookshop ;
SET NAMES utf8mb4;
...
ALTER TABLE `s_admin`
  ADD COLUMN `role` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL DEFAULT 'sales' AFTER `name`;

UPDATE `s_admin` SET `role` = 'admin' WHERE `userName` = 'admin';
INSERT INTO `s_admin` (`userName`, `passWord`, `name`, `lastLoginTime`, `role`) VALUES ('salesperson', 'salesperson', '销售员', NULL, 'sales');
...
ALTER TABLE `s_book`
  ADD COLUMN `stock` int NOT NULL DEFAULT 0 AFTER `imgId`;

UPDATE `s_book` SET `stock` = 100;
...
-- Records of s_order
-- ----------------------------
INSERT INTO `s_order` VALUES (4, '20260105092308536246594163', 1, '2026-01-05 09:23:08', 179.40, 3);
INSERT INTO `s_order` VALUES (5, '202601120547134731083718986', 1, '2026-01-12 15:47:13', 47.40, 3);
INSERT INTO `s_order` VALUES (6, '20260201104729305823772816', 1, '2026-02-01 10:47:29', 31.30, 3);
INSERT INTO `s_order` VALUES (7, '202602051411491251429800191', 1, '2026-02-05 14:11:49', 57.50, 2);
INSERT INTO `s_order` VALUES (8, '202602100802294231181945122', 1, '2026-02-10 08:02:29', 26.90, 3);
INSERT INTO `s_order` VALUES (9, '20260301160642623288276560', 1, '2026-03-01 16:06:42', 20.50, 3);
INSERT INTO `s_order` VALUES (10, '202603050115067252124382547', 1, '2026-03-05 11:15:06', 218.70, 2);
INSERT INTO `s_order` VALUES (11, '202603080323375401848146265', 4, '2026-03-08 23:23:37', 130.70, 1);
INSERT INTO `s_order` VALUES (12, '20260312000256785121692725', 4, '2026-03-12 00:02:56', 132.30, 1);
INSERT INTO `s_order` VALUES (13, '20260315020741681839205568', 5, '2026-03-15 02:07:41', 59.20, 1);
INSERT INTO `s_order` VALUES (14, '202604010425217551086970157', 5, '2026-04-01 04:25:21', 74.80, 1);
INSERT INTO `s_order` VALUES (15, '20260405215417298500592807', 5, '2026-04-05 21:54:17', 147.80, 2);
INSERT INTO `s_order` VALUES (16, '202604081027388351080237993', 1, '2026-04-08 10:27:38', 118.40, 2);
INSERT INTO `s_order` VALUES (17, '20260412113424459696193114', 6, '2026-04-12 11:34:24', 113.00, 3);
INSERT INTO `s_order` VALUES (18, '202604151150042211967104268', 5, '2026-04-15 11:50:04', 105.70, 1);
INSERT INTO `s_order` VALUES (19, '20260418174103389722765893', 7, '2026-04-18 17:41:03', 23.00, 2);
INSERT INTO `s_order` VALUES (20, '202604201743252121876201871', 7, '2026-04-20 17:43:25', 59.50, 1);
INSERT INTO `s_order` VALUES (21, '202605020835574781241358951', 1, '2026-05-02 18:35:57', 57.50, 2);
INSERT INTO `s_order` VALUES (22, '202605080912156789012345678', 3, '2026-05-08 09:12:15', 89.60, 2);
INSERT INTO `s_order` VALUES (23, '202605120425367890123456789', 2, '2026-05-12 14:25:36', 125.30, 3);
INSERT INTO `s_order` VALUES (24, '202605161640223456789012345', 4, '2026-05-16 16:40:22', 98.80, 1);
INSERT INTO `s_order` VALUES (25, '202605201018114567890123456', 5, '2026-05-20 20:18:11', 156.20, 2);
INSERT INTO `s_order` VALUES (26, '202605230923087654321098765', 1, '2026-05-23 09:23:08', 68.00, 1);
INSERT INTO `s_order` VALUES (27, '202605251547131234567890123', 3, '2026-05-25 15:47:13', 192.50, 2);
INSERT INTO `s_order` VALUES (28, '202605271047298765432109876', 2, '2026-05-27 10:47:29', 143.80, 1);
...
INSERT INTO `s_orderitem` VALUES (32, 10, 22, 1);
INSERT INTO `s_orderitem` VALUES (33, 11, 22, 1);
INSERT INTO `s_orderitem` VALUES (34, 26, 23, 1);
INSERT INTO `s_orderitem` VALUES (35, 27, 23, 2);
INSERT INTO `s_orderitem` VALUES (36, 43, 24, 1);
INSERT INTO `s_orderitem` VALUES (37, 44, 24, 1);
INSERT INTO `s_orderitem` VALUES (38, 25, 25, 2);
INSERT INTO `s_orderitem` VALUES (39, 30, 25, 1);
INSERT INTO `s_orderitem` VALUES (40, 8, 26, 1);
INSERT INTO `s_orderitem` VALUES (41, 15, 27, 2);
INSERT INTO `s_orderitem` VALUES (42, 39, 28, 2);
...
-- Records of s_user
-- ----------------------------
INSERT INTO `s_user` VALUES (1, 'user', '1234', '码农小王子', '男', 22, '13812345678', '代码修仙学院', '3380958706@qq.com', 'y');
INSERT INTO `s_user` VALUES (2, 'booklover', '1234', '书香小姐姐', '女', 28, '13987654321', '文艺青年社区', NULL, 'y');
INSERT INTO `s_user` VALUES (3, 'techgeek', '1234', '键盘侠阿强', '男', 25, '13511112222', '硅谷之心公寓', NULL, 'y');
INSERT INTO `s_user` VALUES (4, 'moonlight', '1234', '月光族小美', '女', 26, '13633334444', '月光宝盒小区', NULL, 'y');
INSERT INTO `s_user` VALUES (5, 'coffee', '1234', '咖啡续命君', '男', 30, '13755556666', '拿铁市中心', NULL, 'y');
INSERT INTO `s_user` VALUES (6, 'catlover', '1234', '喵星人守护者', '女', 24, '18899998888', '猫爪胡同6号', NULL, 'y');
INSERT INTO `s_user` VALUES (7, 'gamemaster', '1234', '游戏人生', '男', 21, '19900001111', '电竞半岛', NULL, 'y');
INSERT INTO `s_user` VALUES (8, 'traveler', '1234', '旅行青蛙', '男', 29, '16612345678', '背包客青年旅社', NULL, 'y');
INSERT INTO `s_user` VALUES (9, 'foodie', '1234', '吃货小当家', '女', 27, '17787654321', '美食街88号', NULL, 'y');
INSERT INTO `s_user` VALUES (10, 'stargazer', '1234', '星空观测员', '男', 31, '15511223344', '天文台观星楼', NULL, 'y');
-- 如果从旧库升级，email 列已在 CREATE TABLE 中定义，此处仅做数据更新

UPDATE `s_user` SET `email` = '3380958706@qq.com' WHERE `userName` = 'user';

-- ----------------------------
-- Table structure for s_operation_log
-- ----------------------------
...
CREATE TABLE `s_operation_log`  (
  ...
  `logType` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL,
  `targetId` int NULL,
  `targetName` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL,
  ...
  `catalogId` int NULL,
  `createTime` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL,
...
CREATE TABLE `s_user_profile` (
  ...
  `favCatalogId` int NULL,
  `avgOrderValue` double DEFAULT 0,
...
-- s_operation_log seed data
INSERT INTO `s_operation_log` VALUES (1,1,'user','LOGIN',NULL,NULL,'用户登录','192.168.1.100',0,NULL,'2026-05-20 08:30:00');
INSERT INTO `s_operation_log` VALUES (2,2,'booklover','LOGIN',NULL,NULL,'用户登录','192.168.1.101',0,NULL,'2026-05-21 09:15:00');
INSERT INTO `s_operation_log` VALUES (3,3,'techgeek','LOGIN',NULL,NULL,'用户登录','10.0.0.55',0,NULL,'2026-05-22 10:00:00');
INSERT INTO `s_operation_log` VALUES (4,1,'user','BROWSE',7,'Python基础教程','book detail','192.168.1.100',45,10,'2026-05-20 08:35:00');
INSERT INTO `s_operation_log` VALUES (5,1,'user','BROWSE',10,'C Primer Plus','book detail','192.168.1.100',120,10,'2026-05-20 08:40:00');
INSERT INTO `s_operation_log` VALUES (6,2,'booklover','BROWSE',21,'活着','book detail','192.168.1.101',30,11,'2026-05-21 09:20:00');
INSERT INTO `s_operation_log` VALUES (7,2,'booklover','BROWSE',26,'人生最美是清欢','book detail','192.168.1.101',60,11,'2026-05-21 09:25:00');
INSERT INTO `s_operation_log` VALUES (8,3,'techgeek','BROWSE',9,'现代操作系统','book detail','10.0.0.55',90,10,'2026-05-22 10:05:00');
INSERT INTO `s_operation_log` VALUES (9,4,'moonlight','BROWSE',17,'自在独行','book detail','172.16.0.10',55,11,'2026-05-23 14:00:00');
INSERT INTO `s_operation_log` VALUES (10,5,'coffee','BROWSE',44,'习近平七年知青岁月','book detail','172.16.0.20',80,21,'2026-05-24 11:30:00');
INSERT INTO `s_operation_log` VALUES (11,1,'user','BROWSE',39,'人类简史','book detail','192.168.1.100',35,21,'2026-05-25 16:00:00');
INSERT INTO `s_operation_log` VALUES (12,6,'catlover','BROWSE',33,'窗边的小豆豆','book detail','10.10.10.5',70,17,'2026-05-26 19:00:00');
INSERT INTO `s_operation_log` VALUES (13,1,'user','PURCHASE',NULL,'20260105092308536246594163','amount=179.4,items=3','192.168.1.100',0,NULL,'2026-01-05 09:23:08');
INSERT INTO `s_operation_log` VALUES (14,2,'booklover','PURCHASE',NULL,'202605120425367890123456789','amount=125.3,items=2','192.168.1.101',0,NULL,'2026-05-12 14:25:36');
INSERT INTO `s_operation_log` VALUES (15,1,'user','PURCHASE',NULL,'202605020835574781241358951','amount=57.5,items=1','192.168.1.100',0,NULL,'2026-05-02 18:35:57');
INSERT INTO `s_operation_log` VALUES (16,3,'techgeek','PURCHASE',NULL,'202605080912156789012345678','amount=89.6,items=2','10.0.0.55',0,NULL,'2026-05-08 09:12:15');
INSERT INTO `s_operation_log` VALUES (17,1,'user','PURCHASE',NULL,'202605230923087654321098765','amount=68.0,items=1','192.168.1.100',0,NULL,'2026-05-23 09:23:08');
INSERT INTO `s_operation_log` VALUES (18,2,'booklover','PURCHASE',NULL,'202605271047298765432109876','amount=143.8,items=2','192.168.1.101',0,NULL,'2026-05-27 10:47:29');
INSERT INTO `s_operation_log` VALUES (19,1,'user','EMAIL',NULL,'20260105092308536246594163','status=SUCCESS | to=3380958706@qq.com','192.168.1.100',0,NULL,'2026-01-05 09:23:09');
INSERT INTO `s_operation_log` VALUES (20,2,'booklover','EMAIL',NULL,'202605120425367890123456789','status=SUCCESS | to=null','192.168.1.101',0,NULL,'2026-05-12 14:25:37');
INSERT INTO `s_operation_log` VALUES (21,NULL,'admin','LOGIN',NULL,NULL,'后台登录 role=admin','192.168.1.1',0,NULL,'2026-05-20 08:00:00');
INSERT INTO `s_operation_log` VALUES (22,NULL,'salesperson','LOGIN',NULL,NULL,'后台登录 role=sales','192.168.1.2',0,NULL,'2026-05-20 08:05:00');
INSERT INTO `s_operation_log` VALUES (23,NULL,'admin','LOGIN',NULL,NULL,'后台登录 role=admin','192.168.1.1',0,NULL,'2026-05-27 21:00:00');
INSERT INTO `s_operation_log` VALUES (24,NULL,'salesperson','LOGIN',NULL,NULL,'后台登录 role=sales','192.168.1.2',0,NULL,'2026-05-27 21:30:00');
INSERT INTO `s_operation_log` VALUES (25,NULL,'admin','ADMIN_OP',NULL,'图书管理','修改图书价格','192.168.1.1',0,NULL,'2026-05-20 09:00:00');
INSERT INTO `s_operation_log` VALUES (26,NULL,'salesperson','ADMIN_OP',NULL,'图书管理','添加图书','192.168.1.2',0,NULL,'2026-05-20 10:00:00');
INSERT INTO `s_operation_log` VALUES (27,NULL,'admin','ADMIN_OP',NULL,'人员管理','添加销售人员','192.168.1.1',0,NULL,'2026-05-21 08:00:00');
INSERT INTO `s_operation_log` VALUES (28,NULL,'salesperson','ADMIN_OP',NULL,'订单管理','处理订单发货','192.168.1.2',0,NULL,'2026-05-22 14:00:00');

-- ----------------------------
-- View structure for view_book
-- ----------------------------
DROP VIEW IF EXISTS `view_book`;
CREATE ALGORITHM = UNDEFINED SQL SECURITY DEFINER VIEW `view_book` AS select `s_catalog`.`catalogName` AS `catalogName`,`s_book`.`bookId` AS `bookId`,`s_book`.`catalogId` AS `catalogId`,`s_book`.`bookName` AS `bookName`,`s_book`.`price` AS `price`,`s_book`.`description` AS `description`,`s_book`.`imgId` AS `imgId`,`s_book`.`stock` AS `stock`,`s_uploadimg`.`imgName` AS `imgName`,`s_uploadimg`.`imgSrc` AS `imgSrc`,`s_uploadimg`.`imgType` AS `imgType`,`s_book`.`author` AS `author`,`s_book`.`press` AS `press`,`s_book`.`addTime` AS `addTime` from ((`s_book` join `s_catalog` on((`s_book`.`catalogId` = `s_catalog`.`catalogId`))) join `s_uploadimg` on((`s_book`.`imgId` = `s_uploadimg`.`imgId`)));
